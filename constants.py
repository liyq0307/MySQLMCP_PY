...
class StringConstants:
    ...
    ENV_ALLOWED_QUERY_TYPES: Final[str] = "ALLOWED_QUERY_TYPES"
    ...
    # 默认允许的查询类型
    DEFAULT_ALLOWED_QUERY_TYPES: Final[str] = "SELECT,SHOW,DESCRIBE,INSERT,UPDATE,DELETE,CREATE,DROP,ALTER"
